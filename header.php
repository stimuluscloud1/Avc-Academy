...
<head>
    ...
    <title>iGuru &#8211; Just another WordPress site</title>


    <link rel="stylesheet" type="text/css" href="css/5utbr.css"
        media="all" />
    <style id='rs-plugin-settings-inline-css' type='text/css'>
    #rs-demo-id {}
    </style>

    <link rel="stylesheet" type="text/css" href="css/5utbr2.css"
        media="all" />




    <link rel="stylesheet" type="text/css" href="css/5utbr3.css"
        media="all" />
    ...
    <link rel="stylesheet" type="text/css" href="css/5utbr4.css"
        media="all" />
    ...
    .vc_custom_1569850554436 {
        margin-top: -40px !important;
    }

    .vc_custom_1569853136373 {
        background-color: #00bda6 !important;
    }

    .vc_custom_1569856727231 {
        background-color: #ff6d34 !important;
    }

    .vc_custom_1569858110976 {
        background: #242937 url(http://iguru.wgl-demo.net/wp-content/uploads/2019/09/home_03-bg.jpg?id=2599) !important;
    }

    .vc_custom_1569921687237 {
    ...
    .vc_custom_1571411519157 {
        margin-right: -83px !important;
        margin-left: -83px !important;
        padding-right: 83px !important;
        padding-left: 83px !important;
        background: #00bda6 url(http://iguru.wgl-demo.net/wp-content/uploads/2019/09/counter_bg.jpg?id=2378);
        border-radius: 10px !important;
    }

    .vc_custom_1569929330325 {
    ...
    .vc_custom_1571735404807 {
        padding-right: 40px !important;
    }

    .vc_custom_1571735404841 {
        margin-bottom: 7px !important;
        margin-left: -14px !important;
    }

    .vc_custom_1571735440617 {
        padding-right: 40px !important;
    }

    .vc_custom_1571735440647 {
        margin-bottom: 7px !important;
        margin-left: -14px !important;
    }

    .vc_custom_1569929268514 {
    ...
    .vc_custom_1571233567886 {
        background-color: rgba(255, 255, 255, 0.85) !important;
        *background-color: rgb(255, 255, 255) !important;
    }

    .vc_custom_1571320013130 {
        background-color: rgba(255, 255, 255, 0.85) !important;
        *background-color: rgb(255, 255, 255) !important;
    }

    .vc_custom_1569855452981 {
        padding-top: 15px !important;
    }

    .vc_custom_1569921010610 {
        padding-top: 0px !important;
    }

    .vc_custom_1569921017237 {
        padding-top: 0px !important;
    }

    .vc_custom_1562756145366 {
        padding-top: 0px !important;
    }

    .vc_custom_1572599376946 {
        margin-bottom: 20px !important;
        padding-top: 0px !important;
    }

    .vc_custom_1572599389341 {
        margin-bottom: 20px !important;
        padding-top: 0px !important;
    }

    .vc_custom_1572599516047 {
        margin-bottom: 20px !important;
        padding-top: 0px !important;
    }

    .vc_custom_1572599521382 {
        margin-bottom: 20px !important;
        padding-top: 0px !important;
    }

    .vc_custom_1572599303630 {
        padding-left: 17px !important;
    }

    .vc_custom_1572599288651 {
        padding-left: 17px !important;
    }

    .vc_custom_1572599493522 {
        padding-left: 17px !important;
    }

    .vc_custom_1572599509385 {
        padding-left: 17px !important;
    }

    .vc_custom_1569926223637 {
        padding-top: 0px !important;
    }

    .vc_custom_1569926216624 {
        padding-top: 0px !important;
    }

    .vc_custom_1571405846259 {
        padding-top: 0px !important;
    }
    </style>
    ...
    <script type='text/javascript' src='js/jquery.js?ver=1.12.4-wp'>
    </script>

    <script type='text/javascript'
        src='js/jquery-migrate.min.js?ver=1.4.1'></script>

    <script type='text/javascript'
        src='js/revolution.tools.min.js?ver=6.0'>
    </script>

    <script type='text/javascript'
        src='js/rs6.min.js?ver=6.0.7'></script>

    <script type='text/javascript'
        src='js/perfect-scrollbar.min.js?ver=5.4.2'>
    </script>
    <script type='text/javascript'
        src='js/wgl-toolbar-public.js?ver=1.0.0'>
    </script>
    <script type='text/javascript'
        src='js/jquery.blockUI.min.js?ver=2.70'>
    </script>


    <script type='text/javascript'
        src='js/jquery.swipebox.min.js?ver=5.4.2'>
    </script>

    <script type='text/javascript' src='js/utils.min.js?ver=5.4.2'></script>



    <script type='text/javascript'
        src='js/utils.js?nocache=1599638273.397&#038;ver=3.2.6.10'>
    </script>
...
<body
    class="home page-template-default page page-id-180 theme-iguru woocommerce-no-js wpb-js-composer js-comp-ver-6.0.3 vc_responsive">
                    ...
                    <div class="wgl-container">
                        <div class="wgl-header-row_wrapper" style="height:40px;">
                            <div class='position_left_top header_side display_normal v_align_middle h_align_left'>
                                <div class='header_area_container'>
                                    <div class='bottom_header html1_editor header_render_editor header_render'>
                                        <div class='wrapper'><span style="font-size: 14px; font-weight: 400;"><a
                                                    href="#">27 Division St, New York, NY 10002</a></span></div>
                                    </div>
                                    <div class="delimiter"
                                    ...
                                    <div class='bottom_header html2_editor header_render_editor header_render'>
                                        <div class='wrapper'><span style="font-size: 14px; font-weight: 400;"><a
                                                    href="mailto:iguru@mail.com">iguru@mail.com</a></span></div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class='position_right_top header_side display_normal v_align_middle h_align_right'>
                                <div class='header_area_container'>
                                    <div class="log-in learnpress" style="height:40px;"><a
                                            class="log-link sign-in form-available"
                                            href="http://iguru.wgl-demo.net/profile/?action=sign-in"><i
                                                class="flaticon-user-2"></i>Sign In</a></div>
                                    ...
                                    <div class='bottom_header html3_editor header_render_editor header_render'>
                                        <div class='wrapper'><span style="font-size: 12px;">
                                                <a href="#/twitter.com/"><i class="fa fa-twitter wgl-icon"
                                                        style="padding: 12.5px;"></i></a>
                                                <a href="#/facebook.com/"><i class="fa fa-facebook wgl-icon"
                                                        style="padding: 12.5px;"></i></a>
                                                <a href="#/linkedin.com/"><i class="fa fa-linkedin wgl-icon"
                                                        style="padding: 12.5px;"></i></a>
                                                <a href="#/instagram.com/"><i class="fa fa-instagram wgl-icon"
                                                        style="padding: 12.5px; margin-right: -10px;"></i></a>
                                            </span></div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="wgl-container">
                        <div class="wgl-header-row_wrapper" style="height:100px;">
                            <div class='position_left_middle header_side display_normal v_align_middle h_align_left'>
                                <div class='header_area_container'>
                                    <div class='wgl-logotype-container logo-sticky_enable logo-mobile_enable'>
                                        <a href='http://iguru.wgl-demo.net/'>
                                            <img class="default_logo"
                                                src="http://iguru.wgl-demo.net/wp-content/uploads/2019/10/logo-light.png"
                                ...
                                <div class='header_area_container'>
                                    <nav class='primary-nav menu_line_enable' style="height:100px;">
                                        <ul id="menu-main" class="menu">
                                            <li id="menu-item-3450"
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-180 current_page_item current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-3450">
                                                <a href="http://iguru.wgl-demo.net/"><span>Home</span><i
                                                        class="menu-item__plus"></i></a>
                                                <ul class="sub-menu menu-sub-content">
                                                    <li id="menu-item-3468"
                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-180 current_page_item menu-item-3468">
                                                        <a href="http://iguru.wgl-demo.net/"><span>Home 1</span><i
                                                                class="menu-item__plus"></i></a></li>
                                                    <li id="menu-item-3467"
                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3467">
                                                        <a href="http://iguru.wgl-demo.net/home-2/"><span>Home
                                                                2</span><i class="menu-item__plus"></i></a></li>
                                                    <li id="menu-item-3466"
                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3466">
                                                        <a href="http://iguru.wgl-demo.net/home-3/"><span>Home
                                                                3</span><i class="menu-item__plus"></i></a></li>
                                                </ul>
                                            </li>
                                            <li id="menu-item-3449"
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-3449">
                                                <a href="http://iguru.wgl-demo.net/about-us/"><span>Pages</span><i
                                                        class="menu-item__plus"></i></a>
                                                <ul class="sub-menu menu-sub-content">
                                                    <li id="menu-item-91"
                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-91">
                                                        <a href="http://iguru.wgl-demo.net/about-us/"><span>About
                                                                Us</span><i class="menu-item__plus"></i></a></li>
                                                    <li id="menu-item-66"
                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-66">
                                                        <a href="http://iguru.wgl-demo.net/faqs/"><span>FAQ`s</span><i
                                                                class="menu-item__plus"></i></a></li>
                                                    <li id="menu-item-179"
                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-179">
                                                        <a href="http://iguru.wgl-demo.net/become-a-teacher/"><span>Become
                                                                a Teacher</span><i class="menu-item__plus"></i></a></li>
                                                    <li id="menu-item-511"
                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-511">
                                                        <a href="http://iguru.wgl-demo.net/portfolio-grid/"><span>Portfolio</span><i
                                                                class="menu-item__plus"></i></a>
                                                        <ul class="sub-menu menu-sub-content">
                                                            <li id="menu-item-512"
                                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-512">
                                                                <a href="http://iguru.wgl-demo.net/portfolio-grid/"><span>Portfolio
                                                                        Grid</span><i class="menu-item__plus"></i></a>
                                                                <ul class="sub-menu menu-sub-content">
                                                                    <li id="menu-item-516"
                                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-516">
                                                                        <a
                                                                            href="http://iguru.wgl-demo.net/portfolio-2-columns/"><span>2
                                                                                Columns</span><i
                                                                                class="menu-item__plus"></i></a></li>
                                                                    <li id="menu-item-513"
                                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-513">
                                                                        <a
                                                                            href="http://iguru.wgl-demo.net/portfolio-grid/"><span>3
                                                                                Columns</span><i
                                                                                class="menu-item__plus"></i></a></li>
                                                                    <li id="menu-item-524"
                                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-524">
                                                                        <a
                                                                            href="http://iguru.wgl-demo.net/portfolio-4-columns/"><span>4
                                                                                Columns Wide</span><i
                                                                                class="menu-item__plus"></i></a></li>
                                                                    <li id="menu-item-527"
                                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-527">
                                                                        <a
                                                                            href="http://iguru.wgl-demo.net/portfolio-5-columns/"><span>5
                                                                                Columns Wide</span><i
                                                                                class="menu-item__plus"></i></a></li>
                                                                </ul>
                                                            </li>
                                                            <li id="menu-item-532"
                                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-532">
                                                                <a href="http://iguru.wgl-demo.net/portfolio-grid/"><span>Grid
                                                                        Content Position</span><i
                                                                        class="menu-item__plus"></i></a>
                                                                <ul class="sub-menu menu-sub-content">
                                                                    <li id="menu-item-533"
                                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-533">
                                                                        <a
                                                                            href="http://iguru.wgl-demo.net/portfolio-grid/"><span>Inside
                                                                                Image Content</span><i
                                                                                class="menu-item__plus"></i></a></li>
                                                                    <li id="menu-item-534"
                                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-534">
                                                                        <a
                                                                            href="http://iguru.wgl-demo.net/portfolio-grid-under-image-info/"><span>Under
                                                                                Image Content</span><i
                                                                                class="menu-item__plus"></i></a></li>
                                                                </ul>
                                                            </li>
                                                            <li id="menu-item-552"
                                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-552">
                                                                <a
                                                                    href="http://iguru.wgl-demo.net/portfolio-masonry-style-3/"><span>Portfolio
                                                                        Masonry</span><i
                                                                        class="menu-item__plus"></i></a>
                                                                <ul class="sub-menu menu-sub-content">
                                                                    <li id="menu-item-553"
                                                                        ...
                                                                        <a
                                                                            href="http://iguru.wgl-demo.net/portfolio-masonry-style-2/"><span>Portfolio
                                                                                Masonry Style 2</span><i
                                                                                class="menu-item__plus"></i></a></li>
                                                                    <li id="menu-item-554"
                                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-554">
                                                                        <a
                                                                            href="http://iguru.wgl-demo.net/portfolio-masonry-style-3/"><span>Portfolio
                                                                                Masonry Style 3</span><i
                                                                                class="menu-item__plus"></i></a></li>
                                                                    <li id="menu-item-559"
                                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-559">
                                                                        <a
                                                                            href="http://iguru.wgl-demo.net/portfolio-masonry-style-4/"><span>Portfolio
                                                                                Masonry Style 4</span><i
                                                                                class="menu-item__plus"></i></a></li>
                                                                </ul>
                                                            </li>
                                                            <li id="menu-item-3455"
                                                                class="menu-item menu-item-type-post_type menu-item-object-portfolio menu-item-has-children menu-item-3455">
                                                                <a
                                                                    href="http://iguru.wgl-demo.net/portfolio/typography-design/"><span>Single
                                                                        Layout</span><i class="menu-item__plus"></i></a>
                                                                <ul class="sub-menu menu-sub-content">
                                                                    <li id="menu-item-3454"
                                                                        class="menu-item menu-item-type-post_type menu-item-object-portfolio menu-item-3454">
                                                                        <a
                                                                            href="http://iguru.wgl-demo.net/portfolio/technology-innovation/"><span>Title
                                                                                First</span><i
                                                                                class="menu-item__plus"></i></a></li>
                                                                    <li id="menu-item-3453"
                                                                        class="menu-item menu-item-type-post_type menu-item-object-portfolio menu-item-3453">
                                                                        <a
                                                                            href="http://iguru.wgl-demo.net/portfolio/typography-design/"><span>Image
                                                                                First (Theme Default)</span><i
                                                                                class="menu-item__plus"></i></a></li>
                                                                    <li id="menu-item-3452"
                                                                        class="menu-item menu-item-type-post_type menu-item-object-portfolio menu-item-3452">
                                                                        <a
                                                                            href="http://iguru.wgl-demo.net/portfolio/content-strategy/"><span>Overlay
                                                                                Image</span><i
                                                                                class="menu-item__plus"></i></a></li>
                                                                    <li id="menu-item-3451"
                                                                        class="menu-item menu-item-type-post_type menu-item-object-portfolio menu-item-3451">
                                                                        <a
                                                                            href="http://iguru.wgl-demo.net/portfolio/product-development/"><span>Overlay
                                                                                Image with Info</span><i
                                                                                class="menu-item__plus"></i></a></li>
                                                                </ul>
                                                            </li>
                                                            <li id="menu-item-567"
                                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-567">
                                                                <a href="http://iguru.wgl-demo.net/portfolio-gallery/"><span>Portfolio
                                                                        Gallery</span><i
                                                                        class="menu-item__plus"></i></a></li>
                                                        </ul>
                                                    </li>
                                                    <li id="menu-item-90"
                                                        ...
                                                        <a href="http://iguru.wgl-demo.net/coming-soon/"><span>Coming
                                                                Soon</span><i class="menu-item__plus"></i></a></li>
                                                    <li id="menu-item-67"
                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-67">
                                                        <a href="http://iguru.wgl-demo.net/elements/"><span>Elements</span><i
                                                                class="menu-item__plus"></i></a></li>
                                                    <li id="menu-item-68"
                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-68">
                                                        <a href="http://iguru.wgl-demo.net/typography/"><span>Typography</span><i
                                                                class="menu-item__plus"></i></a></li>
                                                    <li id="menu-item-580"
                                                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-580">
                                                        <a href="/404"><span>Page 404</span><i
                                                                class="menu-item__plus"></i></a></li>
                                                </ul>
                                            </li>
                                            <li id="menu-item-1880"
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1880">
                                                <a href="http://iguru.wgl-demo.net/courses-grid/"><span>Courses</span><i
                                                        class="menu-item__plus"></i></a>
                                                <ul class="sub-menu menu-sub-content">
                                                    <li id="menu-item-1896"
                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1896">
                                                        <a href="http://iguru.wgl-demo.net/courses-list/"><span>Courses
                                                                List</span><i class="menu-item__plus"></i></a></li>
                                                    <li id="menu-item-1881"
                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-1881">
                                                        <a href="http://iguru.wgl-demo.net/courses-grid/"><span>Courses
                                                                Grid</span><i class="menu-item__plus"></i></a>
                                                        <ul class="sub-menu menu-sub-content">
                                                            <li id="menu-item-1891"
                                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1891">
                                                                <a href="http://iguru.wgl-demo.net/courses-2-columns/"><span>2
                                                                        Columns</span><i
                                                                        class="menu-item__plus"></i></a></li>
                                                            <li id="menu-item-1886"
                                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1886">
                                                                <a href="http://iguru.wgl-demo.net/courses-3-columns/"><span>3
                                                                        Columns</span><i
                                                                        class="menu-item__plus"></i></a></li>
                                                            <li id="menu-item-1882"
                                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1882">
                                                                <a href="http://iguru.wgl-demo.net/courses-grid/"><span>4
                                                                        Columns</span><i
                                                                        class="menu-item__plus"></i></a></li>
                                                            <li id="menu-item-1892"
                                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1892">
                                                                <a
                                                                    href="http://iguru.wgl-demo.net/courses-4-columns-full-width/"><span>4
                                                                        Columns Full Width</span><i
                                                                        class="menu-item__plus"></i></a></li>
                                                            <li id="menu-item-1909"
                                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1909">
                                                                <a
                                                                    href="http://iguru.wgl-demo.net/courses-5-columns-full-width/"><span>5
                                                                        Columns Full Width</span><i
                                                                        class="menu-item__plus"></i></a></li>
                                                        </ul>
                                                    </li>
                                                    <li id="menu-item-3167"
                                                        class="menu-item menu-item-type-post_type menu-item-object-lp_course menu-item-3167">
                                                        <a
                                                            href="http://iguru.wgl-demo.net/course/english-for-science-technology-engineering/"><span>Course
                                                                Single</span><i class="menu-item__plus"></i></a></li>
                                                    <li id="menu-item-2788"
                                                        class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2788">
                                                        <a href="/profile/user3/"><span>Instructor Profile</span><i
                                                                class="menu-item__plus"></i></a></li>
                                                    <li id="menu-item-2787"
                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2787">
                                                        <a href="http://iguru.wgl-demo.net/profile/"><span>My
                                                                Profile</span><i class="menu-item__plus"></i></a></li>
                                                </ul>
                                            </li>
                                            <li id="menu-item-403"
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-403">
                                                <a href="http://iguru.wgl-demo.net/blog-grid/"><span>Blog</span><i
                                                        class="menu-item__plus"></i></a>
                                                <ul class="sub-menu menu-sub-content">
                                                    <li id="menu-item-431"
                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-431">
                                                        <a href="http://iguru.wgl-demo.net/blog-list/"><span>Blog
                                                                List</span><i class="menu-item__plus"></i></a></li>
                                                    <li id="menu-item-404"
                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-404">
                                                        <a href="http://iguru.wgl-demo.net/blog-grid/"><span>Blog
                                                                Grid</span><i class="menu-item__plus"></i></a>
                                                        <ul class="sub-menu menu-sub-content">
                                                            <li id="menu-item-409"
                                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-409">
                                                                <a href="http://iguru.wgl-demo.net/grid-2-columns/"><span>2
                                                                        Columns</span><i
                                                                        class="menu-item__plus"></i></a></li>
                                                            <li id="menu-item-405"
                                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-405">
                                                                <a href="http://iguru.wgl-demo.net/blog-grid/"><span>3
                                                                        Columns</span><i
                                                                        class="menu-item__plus"></i></a></li>
                                                            <li id="menu-item-412"
                                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-412">
                                                                <a
                                                                    href="http://iguru.wgl-demo.net/grid-4-columns-full-width/"><span>4
                                                                        Columns Full Width</span><i
                                                                        class="menu-item__plus"></i></a></li>
                                                        </ul>
                                                    </li>
                                                    <li id="menu-item-434"
                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-434">
                                                        <a href="http://iguru.wgl-demo.net/blog-masonry/"><span>Blog
                                                                Masonry</span><i class="menu-item__plus"></i></a>
                                                        <ul class="sub-menu menu-sub-content">
                                                            <li id="menu-item-438"
                                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-438">
                                                                <a href="http://iguru.wgl-demo.net/2-columns/"><span>2
                                                                        Columns</span><i
                                                                        class="menu-item__plus"></i></a></li>
                                                            <li id="menu-item-447"
                                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-447">
                                                                <a href="http://iguru.wgl-demo.net/2-columns-sidebar/"><span>2
                                                                        Columns + Sidebar</span><i
                                                                        class="menu-item__plus"></i></a></li>
                                                            <li id="menu-item-435"
                                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-435">
                                                                <a href="http://iguru.wgl-demo.net/blog-masonry/"><span>3
                                                                        Columns</span><i
                                                                        class="menu-item__plus"></i></a></li>
                                                            <li id="menu-item-442"
                                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-442">
                                                                <a href="http://iguru.wgl-demo.net/4-columns/"><span>4
                                                                        Columns</span><i
                                                                        class="menu-item__plus"></i></a></li>
                                                        </ul>
                                                    </li>
                                                    <li id="menu-item-450"
                                                        class="menu-item menu-item-type-post_type menu-item-object-post menu-item-has-children menu-item-450">
                                                        <a
                                                            href="http://iguru.wgl-demo.net/2019/07/11/top-best-10-tips-for-learning-at-work/"><span>Blog
                                                                Single</span><i class="menu-item__plus"></i></a>
                                                        <ul class="sub-menu menu-sub-content">
                                                            <li id="menu-item-2487"
                                                                class="menu-item menu-item-type-post_type menu-item-object-post menu-item-2487">
                                                                <a
                                                                    href="http://iguru.wgl-demo.net/2019/07/11/what-can-communities-do-to-help-themselves/"><span>Standart</span><i
                                                                        class="menu-item__plus"></i></a></li>
                                                            <li id="menu-item-2488"
                                                                class="menu-item menu-item-type-post_type menu-item-object-post menu-item-2488">
                                                                <a
                                                                    href="http://iguru.wgl-demo.net/2019/07/11/tips-to-help-you-avoid-awkward-networking-2/"><span>Video</span><i
                                                                        class="menu-item__plus"></i></a></li>
                                                            <li id="menu-item-2489"
                                                                class="menu-item menu-item-type-post_type menu-item-object-post menu-item-2489">
                                                                <a
                                                                    href="http://iguru.wgl-demo.net/2019/07/11/how-to-maximize-instructional-design-2/"><span>Gallery</span><i
                                                                        class="menu-item__plus"></i></a></li>
                                                            <li id="menu-item-2491"
                                                                class="menu-item menu-item-type-post_type menu-item-object-post menu-item-2491">
                                                                <a
                                                                    href="http://iguru.wgl-demo.net/2019/07/11/igurus-transition-to-a-new-technology-platform/"><span>Link</span><i
                                                                        class="menu-item__plus"></i></a></li>
                                                            <li id="menu-item-456"
                                                                class="menu-item menu-item-type-post_type menu-item-object-post menu-item-456">
                                                                <a
                                                                    href="http://iguru.wgl-demo.net/2019/07/11/find-your-next-course-faster-search-by-skill/"><span>Quote</span><i
                                                                        class="menu-item__plus"></i></a></li>
                                                            <li id="menu-item-457"
                                                                class="menu-item menu-item-type-post_type menu-item-object-post menu-item-457">
                                                                <a
                                                                    href="http://iguru.wgl-demo.net/2019/07/11/verify-your-certificate-ensure-academic-integrity/"><span>Music</span><i
                                                                        class="menu-item__plus"></i></a></li>
                                                        </ul>
                                                    </li>
                                                    <li id="menu-item-458"
                                                        class="menu-item menu-item-type-post_type menu-item-object-post menu-item-has-children menu-item-458">
                                                        <a
                                                            href="http://iguru.wgl-demo.net/2019/07/11/top-best-10-tips-for-learning-at-work/"><span>Single
                                                                Layout</span><i class="menu-item__plus"></i></a>
                                                        <ul class="sub-menu menu-sub-content">
                                                            <li id="menu-item-2206"
                                                                class="menu-item menu-item-type-post_type menu-item-object-post menu-item-2206">
                                                                <a
                                                                    href="http://iguru.wgl-demo.net/2019/07/11/top-courses-for-learning-exploring-typography-2/"><span>Title
                                                                        First</span><i class="menu-item__plus"></i></a>
                                                            </li>
                                                            <li id="menu-item-2207"
                                                                class="menu-item menu-item-type-post_type menu-item-object-post menu-item-2207">
                                                                <a
                                                                    href="http://iguru.wgl-demo.net/2019/07/11/famous-fictional-examples-of-management-styles-2/"><span>Image
                                                                        First</span><i class="menu-item__plus"></i></a>
                                                            </li>
                                                            <li id="menu-item-2203"
                                                                class="menu-item menu-item-type-post_type menu-item-object-post menu-item-2203">
                                                                <a
                                                                    href="http://iguru.wgl-demo.net/2019/07/11/what-can-communities-do-to-help-themselves/"><span>Overlay
                                                                        Image</span><i class="menu-item__plus"></i></a>
                                                            </li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            ...
                                            <li id="menu-item-3420"
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-3420">
                                                <a href="http://iguru.wgl-demo.net/shop/"><span>Shop</span><i
                                                        class="menu-item__plus"></i></a>
                                                <ul class="sub-menu menu-sub-content">
                                                    <li id="menu-item-3424"
                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3424">
                                                        <a href="http://iguru.wgl-demo.net/shop/"><span>Products
                                                                Grid</span><i class="menu-item__plus"></i></a></li>
                                                    <li id="menu-item-3421"
                                                        class="menu-item menu-item-type-post_type menu-item-object-product menu-item-3421">
                                                        <a
                                                            href="http://iguru.wgl-demo.net/product/wordpress-5-complete/"><span>Product
                                                                Single</span><i class="menu-item__plus"></i></a></li>
                                                    <li id="menu-item-3419"
                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3419">
                                                        <a href="http://iguru.wgl-demo.net/cart/"><span>Cart</span><i
                                                                class="menu-item__plus"></i></a></li>
                                                    <li id="menu-item-3426"
                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3426">
                                                        <a href="http://iguru.wgl-demo.net/checkout-2/"><span>Checkout</span><i
                                                                class="menu-item__plus"></i></a></li>
                                                </ul>
                                            </li>
                                            <li id="menu-item-102"
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-102">
                                                <a href="http://iguru.wgl-demo.net/contacts/"><span>Contacts</span><i
                                                        class="menu-item__plus"></i></a></li>
                                        </ul>
                                    </nav>
                            ...
                            <div class='position_right_middle header_side display_normal v_align_middle h_align_right'>
                                <div class='header_area_container'>
                                    <div class='mini-cart woocommerce' style="height:100px;"> <a class="woo_icon"
                                    ...
                                    <div class="header_search search_standard" style="height:100px;">
                                        <div class="header_search-button"><svg version="1.1"
...
s118-52.8,118-118S183.2,0,118,0L118,0z" />
                                        ...
                                        <div class="header_search-field">
                                            <form role="search" method="get" action="http://iguru.wgl-demo.net/"
                                                class="search-form">
                                                <input type="text" id="search-form-5f588b019022f" class="search-field"
        ...
        <div class='wgl-sticky-header header_sticky_shadow'
            style="background-color: rgba(255,255,255,1);color: #2c2c2c;" data-style="scroll_up">
            <div class='container-wrapper'>
                <div class="wgl-header-row wgl-header-row-section_middle">
                    <div class="wgl-container">
                        <div class="wgl-header-row_wrapper" style="height:100px;">
                                    ...
                                    <div class='wgl-logotype-container logo-sticky_enable logo-mobile_enable'>
                                        <a href='http://iguru.wgl-demo.net/'>
                                            <img class="logo-sticky"
                                                src="http://iguru.wgl-demo.net/wp-content/uploads/2019/10/logo-dark.png"
                                                alt="" style="height:34px;">
                                        </a>
                                    </div>
                                </div>
...
s118-52.8,118-118S183.2,0,118,0L118,0z" />
                                        ...
                                        <div class="header_search-field">
                                            <form role="search" method="get" action="http://iguru.wgl-demo.net/"
                                                class="search-form">
                                                <input type="text" id="search-form-5f588b023734b" class="search-field"
                                                    placeholder="Search &hellip;" value="" name="s" />
                                                <input class="search-button" type="submit" value="Search">
                                                <i class="search__icon"></i>
                                            </form>
                    ...
                    <div class="wgl-container">
                        <div class="wgl-header-row_wrapper" style="height:100px;">
                            ...
                            <div class='position_right header_side'>
                                <div class='header_area_container'>
                                    <div class="log-in learnpress" style="height:100px;"><a
                                            class="log-link sign-in form-available" href="?action=sign-in"><i
                                                class="flaticon-user-2"></i>Sign In</a></div>
                                </div>
                            </div>
                        </div>
                                ...
                                <ul id="menu-main-3" class="menu">
                                    <li
                                        ...
                                        <ul class="sub-menu menu-sub-content">
                                            ...
                                            <li
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3467">
                                                <a href="http://iguru.wgl-demo.net/home-2/"><span>Home 2</span><i
                                                        class="menu-item__plus"></i></a></li>
                                            <li
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3466">
                                                <a href="http://iguru.wgl-demo.net/home-3/"><span>Home 3</span><i
                                                        class="menu-item__plus"></i></a></li>
                                        </ul>
                                    </li>
                                    <li
                                        ...
                                        <ul class="sub-menu menu-sub-content">
                                            <li
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-91">
                                                <a href="http://iguru.wgl-demo.net/about-us/"><span>About Us</span><i
                                                        class="menu-item__plus"></i></a></li>
                                            <li
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-66">
                                                <a href="http://iguru.wgl-demo.net/faqs/"><span>FAQ`s</span><i
                                            ...
                                            <li
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-179">
                                                <a href="http://iguru.wgl-demo.net/become-a-teacher/"><span>Become a
                                                        Teacher</span><i class="menu-item__plus"></i></a></li>
                                            <li
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-511">
                                                <a href="http://iguru.wgl-demo.net/portfolio-grid/"><span>Portfolio</span><i
                                                        class="menu-item__plus"></i></a>
                                                <ul class="sub-menu menu-sub-content">
                                                    <li
                                                        ...
                                                        <ul class="sub-menu menu-sub-content">
                                                            ...
                                                            <li
                                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-513">
                                                                <a href="http://iguru.wgl-demo.net/portfolio-grid/"><span>3
                                                                        Columns</span><i
                                                                        class="menu-item__plus"></i></a></li>
                                                            <li
                                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-524">
                                                    ...
                                                    <li
                                                        ...
                                                        <ul class="sub-menu menu-sub-content">
                                                            <li
                                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-533">
                                                                <a href="http://iguru.wgl-demo.net/portfolio-grid/"><span>Inside
                                                                        Image Content</span><i
                                                                        class="menu-item__plus"></i></a></li>
                                                            <li
                                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-534">
                                                    ...
                                                    <li
                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-552">
                                                        <a href="http://iguru.wgl-demo.net/portfolio-masonry-style-3/"><span>Portfolio
                                                                Masonry</span><i class="menu-item__plus"></i></a>
                                                        <ul class="sub-menu menu-sub-content">
                                                            <li
                                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-553">
                                                    ...
                                                    <li
                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-567">
                                                        <a href="http://iguru.wgl-demo.net/portfolio-gallery/"><span>Portfolio
                                                                Gallery</span><i class="menu-item__plus"></i></a></li>
                                                </ul>
                                            </li>
                                            <li
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-90">
                                            ...
                                            <li
                                                class="menu-item menu-item-type-custom menu-item-object-custom menu-item-580">
                                                <a href="/404"><span>Page 404</span><i class="menu-item__plus"></i></a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li
                                        ...
                                        <ul class="sub-menu menu-sub-content">
                                            ...
                                            <li
                                                ...
                                                <ul class="sub-menu menu-sub-content">
                                                    <li
                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1891">
                                                        <a href="http://iguru.wgl-demo.net/courses-2-columns/"><span>2
                                                                Columns</span><i class="menu-item__plus"></i></a></li>
                                                    <li
                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1886">
                                                        <a href="http://iguru.wgl-demo.net/courses-3-columns/"><span>3
                                                                Columns</span><i class="menu-item__plus"></i></a></li>
                                            ...
                                            <li
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2787">
                                                <a href="http://iguru.wgl-demo.net/profile/"><span>My Profile</span><i
                                                        class="menu-item__plus"></i></a></li>
                                        </ul>
                                    </li>
                                    <li
                                        ...
                                        <ul class="sub-menu menu-sub-content">
                                            <li
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-431">
                                                <a href="http://iguru.wgl-demo.net/blog-list/"><span>Blog List</span><i
                                                        class="menu-item__plus"></i></a></li>
                                            <li
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-404">
                                                <a href="http://iguru.wgl-demo.net/blog-grid/"><span>Blog Grid</span><i
                                                        class="menu-item__plus"></i></a>
                                                <ul class="sub-menu menu-sub-content">
                                                    <li
                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-409">
                                                    ...
                                                    <li
                                                        class="menu-item menu-item-type-post_type menu-item-object-page menu-item-412">
                                                        <a href="http://iguru.wgl-demo.net/grid-4-columns-full-width/"><span>4
                                                                Columns Full Width</span><i
                                                                class="menu-item__plus"></i></a></li>
                                                </ul>
                                            </li>
                                            ...
                                            <li
                                                ...
                                                <ul class="sub-menu menu-sub-content">
                                                    <li
                                                        ...
                                                        <a
                                                            href="http://iguru.wgl-demo.net/2019/07/11/top-courses-for-learning-exploring-typography-2/"><span>Title
                                                                First</span><i class="menu-item__plus"></i></a></li>
                                                    <li
                                                        class="menu-item menu-item-type-post_type menu-item-object-post menu-item-2207">
                                                        <a
                                                            href="http://iguru.wgl-demo.net/2019/07/11/famous-fictional-examples-of-management-styles-2/"><span>Image
                                                    ...
                                                    <li
                                                        ...
                                                        <a
                                                            href="http://iguru.wgl-demo.net/2019/07/11/what-can-communities-do-to-help-themselves/"><span>Overlay
                                                                Image</span><i class="menu-item__plus"></i></a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </li>
                                    <li
                                        ...
                                        <ul class="sub-menu menu-sub-content">
                                            <li
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3424">
                                                <a href="http://iguru.wgl-demo.net/shop/"><span>Products Grid</span><i
                                                        class="menu-item__plus"></i></a></li>
                                            <li
                                                class="menu-item menu-item-type-post_type menu-item-object-product menu-item-3421">
                                                <a href="http://iguru.wgl-demo.net/product/wordpress-5-complete/"><span>Product
                                                        Single</span><i class="menu-item__plus"></i></a></li>
                                            <li
                                                class="menu-item menu-item-type-post_type menu-item-object-page menu-item-3419">
                                                <a href="http://iguru.wgl-demo.net/cart/"><span>Cart</span><i
        ...
        <div class="wgl-sign_in_up_form">
            <ul class="sign-in-up-tabs">
                <li class="active"><a href="?tab=tab-login" data-tab=".tab-login">Login</a></li>
                <li><a href="?tab=tab-register" data-tab=".tab-register">Register</a></li>
            </ul>
            <div class="tab-login active">
                <div class="learn-press-form-login learn-press-form">
                    ...
                    <form name="learn-press-login" method="post" action="">
                        <ul class="form-fields">
                            <li class="form-field">
                                <div class="rwmb-field rwmb-text-wrapper ">
                                    ...
                                    <div class="rwmb-field rwmb-text-wrapper "><input size="30"
                                            placeholder="Username or email" type="text" required id="username"
                                            class="rwmb-field rwmb-text-wrapper " name="username"></div><input
                                        type="hidden" class="rwmb-field rwmb-text-wrapper " value="username" />
                            ...
                            <li class="form-field">
                                <div class="rwmb-field rwmb-password-wrapper ">
                                    ...
                                    <div class="rwmb-field rwmb-password-wrapper "><input size="30"
                                            placeholder="Password" type="password" required id="password"
                                            class="rwmb-field rwmb-password-wrapper " name="password"></div><input
                                        type="hidden" class="rwmb-field rwmb-password-wrapper " value="password" />
                        ...
                        <p>
                            <input type="hidden" name="learn-press-login-nonce" value="a22b213bdb">
                    ...
                    <form name="learn-press-register" method="post" action="">
                        <ul class="form-fields">
                            <li class="form-field">
                                <div class="rwmb-field rwmb-text-wrapper ">
                                    ...
                                    <div class="rwmb-field rwmb-text-wrapper "><input size="30" placeholder="Username"
                                            type="text" required id="reg_username" class="rwmb-field rwmb-text-wrapper "
                                            name="reg_username"></div><input type="hidden"
                                        class="rwmb-field rwmb-text-wrapper " value="reg_username" />
                                    <div class="rwmb-field rwmb-text-wrapper "></div>
                                </div>
                            </li>
                            <li class="form-field">
                                <div class="rwmb-field rwmb-email-wrapper ">
                                    ...
                                    <div class="rwmb-field rwmb-email-wrapper "><input size="30" placeholder="Email"
                                            type="email" required id="reg_email" class="rwmb-field rwmb-email-wrapper "
                                            name="reg_email"></div><input type="hidden"
                                        class="rwmb-field rwmb-email-wrapper " value="reg_email" />
                            ...
                            <li class="form-field">
                                <div class="rwmb-field rwmb-password-wrapper ">
                                    ...
                                    <div class="rwmb-field rwmb-password-wrapper "><input size="30"
                                            placeholder="Password" type="password" required id="reg_password"
                                            class="rwmb-field rwmb-password-wrapper " name="reg_password">
                                        <p id="reg_password-description" class='description'>The password should be at
                                            least twelve characters long. To make it stronger, use upper and lower case
                                            letters, numbers, and symbols like ! " ? $ % ^ & )</p>
                                    </div><input type="hidden" class="rwmb-field rwmb-password-wrapper "
                                        value="reg_password" />
                                    <div class="rwmb-field rwmb-password-wrapper "></div>
                                </div>
                            </li>
                        ...
                        <p>
                            <input type="hidden" id="learn-press-register-nonce" name="learn-press-register-nonce"
                                value="0ac0b4c847" /><input type="hidden" name="_wp_http_referer" value="/" /> <button
